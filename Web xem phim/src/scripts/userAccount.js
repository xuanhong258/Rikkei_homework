    ...
    for(let key in users){
        let tr = `
                ...
                <td class="button">
                    ...
                    <a href="sendMailToUser.html?id=${users[key].id}"><i class="fa-regular fa-envelope icon-email"></i></a>
        ...
        if(isCheck){
            for(let value of tmp){
                ...
                let tr = `
                        ...
                        <td class="button">
                            <span><i class="fa-solid fa-pen-to-square icon-edit"></i></span>
                            <a href="sendMailToUser.html?id=${users[value].id}"><i class="fa-regular fa-envelope icon-email"></i></a>
                            <span><i class="fa-solid fa-gear icon-setting"></i></span>
                        </td>
                    </tr>
                `;
